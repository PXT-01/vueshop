<template>
  <header class="app-header navbar">
    ...
    <b-link class="navbar-brand" to="#"><img src="http://127.0.0.1:8000/images/logos/1621605648.png" style="max-width: 100%" alt=""></b-link>
    ...
    <b-nav is-nav-bar class="d-md-down-none">
      <b-nav-item class="px-3" @click="dashboard()">Quản lý</b-nav-item>
    </b-nav>
    <b-nav is-nav-bar class="ml-auto" style="margin-right:15px;">
      <b-nav-item-dropdown right>
        <template slot="button-content">
          <img src="/images/avatar.png" class="img-avatar" alt="avatar">
