...
<div id="header" class="header">
    <div class="top-header">
      <img src="images/banner_top.png" style="width: 100%" alt="">
<!--        <div class="container">-->
                    ...
                    <div class="vertical-menu-content is-home">
                        <ul class="vertical-menu-list">
                            <li v-for="mod_cat in modpro">
                                <a class="parent" href="#"><img class="icon-menu" alt="No image" src="/assets/data/2.png" style="max-width: 40px"> {{mod_cat.mod_name}}</a>
