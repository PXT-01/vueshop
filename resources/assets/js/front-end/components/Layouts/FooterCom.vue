    ...
    <footer id="footer">
        <div class="container">
            <div id="introduce-box" class="row">
                <div class="col-md-3">
                    <div id="address-box">
                        <a href="#"><img :src="setting_logo" alt="Logo" /></a>
                        <div id="address-list">
                            <div class="tit-name">Địa chỉ:</div>
                            <div class="tit-contain">{{setting_address}}</div>
                            <div class="tit-name">Phone:</div>
                            <div class="tit-contain">{{setting_phone}}</div>
                            <div class="tit-name">Email:</div>
                            <div class="tit-contain">{{setting_mail}}</div>
                        </div>
                    </div> 
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-3">
                    <div id="contact-box">
                        <div class="introduce-title">Đăng ký nhận khuyến mại</div>
            ...
            <div id="footer-menu-box">
                ...
                <p class="text-center">&#169; 2021 Fahasa</p>
            </div>
        </div> 
    </footer>
</template>
