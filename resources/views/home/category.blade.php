...
<head>
    ...
    <title>Điện thoại SamSung - KTShop - Thỏa sức mua sắm</title>
</head>
...
<!-- COUNTDOWN -->
<script type="text/javascript" src="{{url('assets/lib/countdown/jquery.plugin.js')}}"></script>
<script type="text/javascript" src="{{url('assets/lib/countdown/jquery.countdown.js')}}"></script>
